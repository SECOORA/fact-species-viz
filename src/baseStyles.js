...
const stamenTerrain = {
  ...
  sources: {
    "raster-tiles": {
      type: "raster",
      // https://tiles.stadiamaps.com/tiles/stamen_terrain/13/1314/3165@2x.png 
      // https://tiles.stadiamaps.com/tiles/stamen_terrain/{z}/{x}/{y}.jpg might work
...
export default {
  greyscale: {
    ...
    style: "mapbox://styles/secoora/cl9x45rpw000l14oyb0594z81",
    thumbnail:
